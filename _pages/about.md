...
![This should be me](/assets/images/bio-photo.jpg){:width="150px" .align-left} Hi! I'm Jacopo Schiavon, a PhD student at the Statistics Department at the University of Padova.
{: .text-justify}
...
:------------ | :-------------
<i class="fas fa-book-reader"></i> Differential Geometry in statistics | <i class="fas fa-graduation-cap"></i> PhD in Statistics
<i class="fas fa-book-reader"></i> Performance computing | <i class="fas fa-graduation-cap"></i> MsC in Physics
<i class="fas fa-book-reader"></i> Computational Statistics | <i class="fas fa-graduation-cap"></i> BsC in Physics